...
class KthSmallestElementInABSTTest {
    ...
    fun kthSmallest() {
        val tests = listOf(
            KthSmallestElementInABSTTestData(treeNodeUtil.generateTreeNodeOrNull(listOf(3, 1, 4, null, 2)), 1, 1),
            KthSmallestElementInABSTTestData(treeNodeUtil.generateTreeNodeOrNull(listOf(5, 3, 6, 2, 4, null, null, 1)), 3, 3)
        )
